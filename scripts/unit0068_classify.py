...
# Load staged data
staged_recs = read_tsv('authority/staging/src0002_batch0005_recordings.tsv')
staged_songs = read_tsv('authority/staging/src0002_batch0005_songs.tsv')
staged_artists = read_tsv('authority/staging/src0002_batch0005_artist_candidates.tsv')
...
write_tsv('authority/staging/src0002_batch0005_artist_promotion.tsv', artist_promotion)
write_tsv('authority/staging/src0002_batch0005_song_promotion.tsv', song_promotion)
write_tsv('authority/staging/src0002_batch0005_recording_promotion.tsv', rec_promotion)
