...
STAGING = ROOT / "authority/staging/unit0103"
REPORT = ROOT / "reports/unit0103/UNIT0103_SRC0003_BLOCK0003_AUDIT_REPORT.md"
...
with (STAGING / "UNIT0103_SRC0003_BLOCK0003_AUDIT.tsv").open("w", encoding="utf-8", newline="") as f:
    w = csv.DictWriter(f, delimiter="\t", fieldnames=["release_title","status","title"], lineterminator="\n")
    w.writeheader()
    w.writerows(audit_rows)

with REPORT.open("w", encoding="utf-8") as f:
    f.write("# UNIT-0103 — SRC0003 Block 0003 Audit Report\n\n")
    f.write("Project: MUSIC_RELATIONSHIPS_DB\n")
    f.write("Unit: UNIT-0103\n\n")
    f.write("## Scope\n\n")
    f.write("- Ray Barretto — Acid\n")
    f.write("- Orchestra Harlow — Salsa\n\n")
    f.write("## Summary\n\n")
