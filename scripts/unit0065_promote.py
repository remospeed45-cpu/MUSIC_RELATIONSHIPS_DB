...
art_promo = read_tsv('authority/staging/src0002_batch0004_artist_promotion.tsv')
song_promo = read_tsv('authority/staging/src0002_batch0004_song_promotion.tsv')
rec_promo = read_tsv('authority/staging/src0002_batch0004_recording_promotion.tsv')
...
rel_rec_song = read_tsv('relationships/staging/src0002_batch0004_recording_song.tsv')
rel_rec_artist = read_tsv('relationships/staging/src0002_batch0004_recording_artist_candidate.tsv')
rel_rec_rel = read_tsv('relationships/staging/src0002_batch0004_recording_release.tsv')
rel_rec_src = read_tsv('relationships/staging/src0002_batch0004_recording_source.tsv')
